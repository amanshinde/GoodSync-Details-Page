...
const ALL_FEATURES = [
  {
    ...
    desc: 'GudERP maintains a structured, searchable student profile for each enrolled learner — covering admission records, guardian details, enrollment lifecycle, document storage, and quick filters across the school.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP supports structured evaluation workflows from exam configuration and bulk marks entry to admin approval and instant result publishing with subject-wise breakdowns.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP supports fee structure setup, installment planning, automated challan generation, and dues tracking — with full parent self-service visibility and export for accounts.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP includes a structured messaging system to reduce dependence on informal channels like WhatsApp. Broadcasts, class-specific messages, and templates — all in one audit-friendly system.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP generates standardized ID cards for students (and optionally staff) using school-branded templates. Auto-populate student details and batch generate for entire classes.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP generates hall tickets (admit cards) for exams with consistent formatting, student details, and integrated exam schedules. Policy-driven rules block generation for ineligible students.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP includes dashboards to help admin make informed decisions — covering attendance trends, academic performance, and fee collection analytics, all exportable for compliance.',
    highlights: [
  ...
  },
  {
    ...
    desc: 'GudERP is designed to reduce parent-school friction by giving parents self-service visibility into attendance, results, fee status, and communication through the mobile app.',
    highlights: [
    ...
    <div className="min-h-screen bg-white font-inter text-slate-900 selection:bg-indigo-600/30 selection:text-indigo-600">
      ...
      <aside className="fixed left-4 xl:left-8 top-24 bottom-6 w-64 xl:w-72 z-40 flex flex-col rounded-3xl bg-white/60 backdrop-blur-2xl border border-white/70 shadow-2xl shadow-slate-200/60 overflow-hidden hidden lg:flex">
        ...
        <div className="px-4 py-4 border-t border-white/50">
          <p className="text-[10px] text-slate-400 text-center font-medium">{ALL_FEATURES.length} features in GudERP</p>
        </div>
      </aside>
